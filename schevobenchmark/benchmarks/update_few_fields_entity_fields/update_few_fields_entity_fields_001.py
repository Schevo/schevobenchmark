"""Benchmark for updating entities where a few of the fields are
entity fields.
...
def x_benchmark_1_update_entity_fields(db):
    # Update 1000 Foo entities to point to different random Bar and
    # Baz entities.
    Foo = db.Foo
    Bar = db.Bar
    Baz = db.Baz
...
def x_benchmark_2_update_integer_fields(db):
